...
public class ImageNameTests
{
    ...
    {
        ImageName imageName = new("repo", "registry.io", digest: "sha256:digest");
    ...
    {
        ImageName imageName = new("repo", "registry.io", "tag");
