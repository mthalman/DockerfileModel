...
///   - #264 (trailing whitespace on instructions): FIXED. The C# parser now drops trailing
///     whitespace tokens from instruction token lists via DropTrailingWhitespace(), matching
///     Lean's behavior.
