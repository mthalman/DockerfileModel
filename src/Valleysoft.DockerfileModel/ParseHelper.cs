...
internal static class ParseHelper
{
    ...
    /// <param name="whitespaceMode">Controls how whitespace is parsed.</param>
    ...
    /// <param name="canContainVariables">Whether the literal supports variable references.</param>
    /// <param name="escapeChar">Escape character.</param>
